...
$res = callController(\App\Http\Controllers\Admin\CourtController::class, 'store',
...
$res = callController(\App\Http\Controllers\BookingController::class, 'checkAvailability',
...
$res = callController(\App\Http\Controllers\BookingController::class, 'checkAvailability',
    ['court_id'=>99999,'date'=>now()->format('Y-m-d')], $customer);
...
$res = callController(\App\Http\Controllers\BookingController::class, 'checkAvailability',
    ['court_id'=>$court?->id ?? 1,'date'=>'bukan-tanggal'], $customer);
...
if ($pendingBooking) {
    $res = callController(\App\Http\Controllers\Admin\PaymentController::class, 'reject',
        ['rejection_reason'=>''], $admin, [$pendingBooking->id]);
...
$res = callController(\App\Http\Controllers\Admin\BookingController::class, 'store',
...
$res = callController(\App\Http\Controllers\ProfileController::class, 'updateBiodata',
    ['phone'=>'081234567890'], $customer);
...
$res = callController(\App\Http\Controllers\ProfileController::class, 'updateBiodata',
    ['phone'=>'081234567890123456789'], $customer);
...
$res = callController(\App\Http\Controllers\ProfileController::class, 'updateBiodata',
    ['phone'=>'08123456789012345678'], $customer);
...
$res = callController(\App\Http\Controllers\ProfileController::class, 'destroy',
    ['password'=>''], $customer);
...
$res = callController(\App\Http\Controllers\Admin\UserController::class, 'update',
