...
<body
    ...
    <div class="flex min-h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
            class="fixed inset-y-0 left-0 z-50 flex flex-col h-full bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-700 shadow-sm transition-transform duration-300 w-64 shrink-0">

            <!-- HEADER / LOGO -->
            <div
                class="flex items-center justify-between px-6 h-16 border-b border-gray-100 dark:border-gray-700 shrink-0">
            ...
            <nav
                ...
                <a href="{{ route('customer.dashboard') }}"
                    ...
                    {{ request()->routeIs('customer.dashboard') ? 'bg-yellow-50 dark:bg-gray-800 text-yellow-600 dark:text-gray-100 font-medium' : 'hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-800 dark:hover:text-gray-100' }}">
                    <i data-lucide="layout-dashboard"
                        class="w-5 h-5 shrink-0 transition-colors {{ request()->routeIs('customer.dashboard') ? 'text-yellow-600 dark:text-gray-100' : 'text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300' }}"></i>
                    <span class="text-sm">Dashboard</span>
                </a>

                <a href="{{ route('booking.create') }}"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                    {{ request()->routeIs('booking.create') ? 'bg-yellow-50 dark:bg-gray-800 text-yellow-600 dark:text-gray-100 font-medium' : 'hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-800 dark:hover:text-gray-100' }}">
                    <i data-lucide="calendar-plus"
                        class="w-5 h-5 shrink-0 transition-colors {{ request()->routeIs('booking.create') ? 'text-yellow-600 dark:text-gray-100' : 'text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300' }}"></i>
                    <span class="text-sm">Booking Lapangan</span>
                </a>

                <a href="{{ route('profile.edit') }}"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-800 dark:hover:text-gray-100">
                    <i data-lucide="user"
                        class="w-5 h-5 shrink-0 transition-colors text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300"></i>
            ...
            <div
                ...
                <div x-data="{ openUser: false }" class="relative">
                    <button @click="openUser = !openUser"
                        ...
                        <i data-lucide="more-vertical" class="w-4 h-4 text-gray-400 dark:text-gray-500 shrink-0"></i>
                    </button>
        ...
        <!-- MAIN WRAPPER -->
        <div
            class="flex-1 flex flex-col min-w-0 lg:ml-64 bg-gray-50 dark:bg-gray-900 h-screen transition-colors duration-200">

            <!-- HEADER -->
            <header
                class="h-16 shrink-0 flex items-center justify-between px-4 md:px-6 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-700 shadow-sm z-30 w-full transition-all duration-300">
                <div class="flex items-center gap-4 min-w-0">
                    ...
                    <div class="min-w-0">
                        <h1
                            class="text-lg sm:text-xl font-semibold text-gray-800 dark:text-gray-100 truncate flex items-center gap-2">
                ...
                <div class="flex items-center gap-3 shrink-0">
                    ...
                    <button @click="dark = !dark"
                        class="p-2 rounded-lg text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 transition-colors duration-200 focus:outline-none">
                    ...
                    <div class="hidden sm:flex flex-col items-end text-sm">
                        <span class="font-medium text-gray-800 dark:text-gray-100">{{ auth()->user()->name }}</span>
