    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative group">
                ...
                {{-- Floating Badge --}}
                <div
                    class="absolute -bottom-8 -right-8 bg-white p-6 rounded-3xl shadow-2xl border border-gray-100 z-20 animate-float">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-xs font-bold text-gray-500 uppercase tracking-widest">Kualitas</p>
                            <p class="text-lg font-black text-gray-900">Premium Court</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Content -->
            <div class="lg:pl-8">
                <h3 class="text-2xl font-bold text-gray-900 mb-6">Pengalaman Bermain Terbaik di Purwokerto</h3>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-6">
                    <div
                        class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all duration-500">
                        <p class="text-4xl font-black text-primary mb-1 tracking-tighter">500+</p>
                        <p class="text-xs text-gray-500 font-bold uppercase tracking-wider">Pemain</p>
                    </div>

                    <div
                        class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all duration-500">
                        <p class="text-4xl font-black text-primary mb-1 tracking-tighter">2</p>
                        <p class="text-xs text-gray-500 font-bold uppercase tracking-wider">Lapangan</p>
                    </div>

                    <div
                        class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all duration-500 col-span-2 sm:col-span-1">
                        <p
                            class="text-2xl font-black text-primary mb-1 tracking-tighter leading-none h-[40px] flex items-center">
                            Real-Time</p>
                        <p class="text-xs text-gray-500 font-bold uppercase tracking-wider">Booking</p>
                    </div>
                </div>
