<section id="pricing" class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 class="text-4xl font-extrabold text-gray-900 mt-2 sm:text-5xl tracking-tight leading-tight">
        ...
        <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <!-- Lapangan A -->
            <div
                class="bg-white rounded-[2rem] p-10 shadow-sm border border-gray-100 hover:shadow-2xl hover:shadow-gray-200/50 hover:-translate-y-2 transition-all duration-500 relative group flex flex-col">
                <div class="flex items-center justify-between mb-8">
                    <div>
                        <span class="text-primary text-xs font-bold uppercase tracking-widest mb-1 block">Standar</span>
                        <h3 class="text-3xl font-black text-gray-900">Lapangan A</h3>
                    </div>
                    <div
                        class="w-14 h-14 bg-neutralBg rounded-2xl flex items-center justify-center group-hover:bg-primary/10 transition-all duration-500 shadow-inner">
                        <i data-lucide="sun"
                ...
                <div class="mb-8 flex-grow">
                    <div class="flex items-baseline gap-1">
                        <span class="text-5xl font-black text-gray-900 tracking-tighter">Rp50rb</span>
                        <span class="text-gray-400 font-bold">/jam</span>
                    </div>
                    <p class="text-gray-500 mt-4 leading-relaxed">
                        Lapangan semi-indoor dengan lantai material <span class="text-gray-900 font-semibold">rubber
                            cushion</span> berkualitas.
                    </p>
                </div>

                <div class="border-t border-gray-50 pt-8 mb-10">
                    <ul class="space-y-4">
                        <li class="flex items-center gap-3 group/item">
                            <div
                                class="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center group-hover/item:scale-110 transition-transform">
                                <i data-lucide="check" class="w-3.5 h-3.5 text-green-600"></i>
                            </div>
                            <span class="text-gray-600 font-medium text-sm">Material Rubber Cushion</span>
                        </li>
                        <li class="flex items-center gap-3 group/item">
                            <div
                                class="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center group-hover/item:scale-110 transition-transform">
                            ...
                            <span class="text-gray-600 font-medium text-sm">Atap Kanopi Anti Tampyas</span>
                        </li>
                        <li class="flex items-center gap-3 group/item">
                            <div
                                class="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center group-hover/item:scale-110 transition-transform">
                            ...
                            <span class="text-gray-600 font-medium text-sm">Lampu LED 400W (6 Titik)</span>
                        </li>
                    </ul>
                </div>

                <a href="{{ route('register') ?? '#' }}"
                    class="w-full inline-flex justify-center items-center py-4 px-6 rounded-2xl text-base font-bold text-gray-700 bg-gray-50 hover:bg-gray-100 hover:text-gray-900 transition-all active:scale-95 border border-gray-100">
                    Pilih Lapangan A
                </a>
            </div>
            ...
            <div
                class="bg-gray-900 rounded-[2rem] p-10 shadow-2xl shadow-gray-900/20 hover:-translate-y-2 transition-all duration-500 relative flex flex-col group overflow-hidden">
                {{-- Branded Glow --}}
