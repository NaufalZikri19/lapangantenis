<section id="court" class="py-28 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="text-center mb-20">
            ...
            <h2 class="text-4xl font-bold text-gray-900 dark:text-white mt-3">
                Jenis Lapangan
            </h2>
        ...
        <div class="grid md:grid-cols-2 gap-12">
            ...
            <div
                ...
                <div class="p-8">
                    ...
                    <!-- INFO -->
                    <div class="grid grid-cols-2 gap-5 mt-6 text-sm text-gray-600 dark:text-gray-300">

                        <div class="flex items-start gap-2">
                            <i data-lucide="clock" class="w-4 h-4 text-yellow-500 mt-1"></i>
                            <div>
                                <p class="font-medium text-gray-800 dark:text-white">Jam</p>
                                <p>08.00 – 22.00</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                <p class="font-medium text-gray-800 dark:text-white">Kapasitas</p>
                                <p>2–4 Pemain</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                <p class="font-medium text-gray-800 dark:text-white">Lantai</p>
                                <p>Vinly</p>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2 text-xs">
                            <span class="bg-gray-100 dark:bg-gray-750 dark:text-gray-350 px-3 py-1 rounded-full">Tersedia Papan Skor</span>
                            <span class="bg-gray-100 dark:bg-gray-750 dark:text-gray-350 px-3 py-1 rounded-full">Penerangan</span>
                            <span class="bg-gray-100 dark:bg-gray-750 dark:text-gray-350 px-3 py-1 rounded-full">Area Penonton</span>
                        </div>
                    </div>
            ...
            <div
                ...
                <div class="p-8">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2 text-xs">
                            <span class="bg-gray-100 dark:bg-gray-750 dark:text-gray-350 px-3 py-1 rounded-full">Penerangan</span>
                            <span class="bg-gray-100 dark:bg-gray-750 dark:text-gray-350 px-3 py-1 rounded-full">Ruang Ganti</span>
                            <span class="bg-gray-100 dark:bg-gray-750 dark:text-gray-350 px-3 py-1 rounded-full">Area Parkir</span>
                        </div>
                    </div>
