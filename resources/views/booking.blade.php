    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <select class="w-full border border-gray-300 rounded-xl px-4 py-2 focus:ring-2 focus:ring-yellow-400">
    ...
    <div class="grid lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-3 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div class="grid grid-cols-3 md:grid-cols-6 gap-4">
                ...
                <button class="py-3 rounded-xl bg-green-100 text-green-700 hover:bg-green-200 transition font-medium">
                    08:00
                </button>
                ...
                <button disabled
                    class="py-3 rounded-xl bg-gray-200 text-gray-400 cursor-not-allowed font-medium">
                    10:00
                </button>
